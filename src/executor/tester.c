...
// 		if (full_path == NULL)
// 			return (ft_free(all_path, path), mini->last_exit = errno, perror("malloc"), NULL);
// 		if (access(full_path, F_OK || X_OK) == 0)
// 			return (ft_free(all_path, path), full_path);
// 		i++;
// 	}
...
// 	if (path == NULL)
// 		return (ft_free(all_path, NULL), mini->last_exit = errno, perror("malloc"), NULL);
...
// {
// 	if (current_cmd->parsing_error == 0 && current_cmd->args[0] == NULL)
// 		return (0);
// 	if (current_cmd->parsing_error != 0)
// 	{
// 		ft_error_msg(current_cmd->args[0], NULL, strerror(current_cmd->parsing_error));
// 		mini->last_exit = current_cmd->parsing_error;
// 		return (0);
// 	}
